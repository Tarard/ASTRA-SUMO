...
This reference is a workflow and audit protocol. It can guide ASTRA, Codex, Claude, or a human reviewer, but it is not proof that the current plugin can automatically run the full reconstruction.
