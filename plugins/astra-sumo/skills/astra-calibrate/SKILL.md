...
Use this skill as a compact knowledge base for fitting traffic behavior and observations to a SUMO model. The agent may choose whichever ASTRA workflow, SUMO utility, code path, or reference best fits the task.
