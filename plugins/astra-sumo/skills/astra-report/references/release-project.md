# ASTRA Release Review

Use this reference before publishing a ASTRA repository or plugin release. It reviews public exposure and packaging; selecting it does not authorize publication.

## Current Bundle

ASTRA is one plugin with four topic skills:
...
- Network and infrastructure construction belongs to `$astra-build`.
- Demand reconstruction and observation calibration belong to `$astra-calibrate`.
- Experiment planning, execution, debugging, and controller diagnosis belong to `$astra-simulate`.
- Completed-result interpretation, traffic reports, reusable lesson capture, and release evidence belong to `$astra-report`.
