...
NETWORK_PLAN_QUESTION = (
    "Which traffic layers should ASTRA model: passenger vehicles, service/access roads, "
    "bicycle, pedestrian, bus/public transport, or a reference-matched SUMO network?"
)
REFERENCE_PLAN_QUESTION = (
    "Which reference SUMO .net.xml or reference policy report should ASTRA use to infer the matched road layers?"
)
