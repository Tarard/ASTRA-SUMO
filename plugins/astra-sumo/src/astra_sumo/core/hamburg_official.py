...
class SensorThingsClient:
    ...
    def collection(
        ...
        *,
        ...
        for _page_index in range(self.max_pages):
            ...
            request = Request(url, headers={"Accept": "application/json", "User-Agent": "ASTRA-SUMO/1.0"})
    ...
    def bytes(self, url: str) -> bytes:
        ...
        request = Request(url, headers={"Accept": "application/xml,text/xml,*/*", "User-Agent": "ASTRA-SUMO/1.0"})
...
def download_hamburg_traffic_light_catalog(
    ...
    *,
    ...
    request = Request(
        catalog_api_url,
        headers={"Accept": "application/json", "User-Agent": "ASTRA-SUMO/1.1"},
    )
    try:
    ...
    if not usage_cache_hit:
        usage_request = Request(
            ...
            headers={"Accept": "application/pdf", "User-Agent": "ASTRA-SUMO/1.1"},
        )
...
def discover_hamburg_signal_assets(
    ...
    *,
    ...
    for key, url in (
        ...
        request = Request(
            url,
            headers={"Accept": "text/html", "User-Agent": "ASTRA-SUMO/1.1"},
        )
        try:
