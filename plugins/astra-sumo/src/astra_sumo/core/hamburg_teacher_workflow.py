...
def run_hamburg_teacher_replay_workflow(
    *,
    ...
    """Sequentially apply official Hamburg teachers through ASTRA's native replay.
    ...
    SUMO load, routeability smoke, and via-semantics gate remains inside ASTRA's
    ...
    for stage_index, contract in enumerate(contracts, start=1):
        ...
        if shared_controller:
            # ASTRA's shared-controller safety path requires a distinct promotion
            # candidate.  This is a byte-identical staging copy; ASTRA still owns
