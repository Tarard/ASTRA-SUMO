...
def rebuild_hamburg_sandtorkai_official_tls(
    *,
    ...
    try:
        ...
        # making the ASTRA-native engine explicit in the artifact itself.
        ...
        if rebuild_report.get("status") != "pass":
            raise ValueError(
                "ASTRA-native official TLS replay failed: "
                + str(
        ...
        if not rebuilt_net_file.is_file():
            raise ValueError("ASTRA-native replay reported pass without a final net file")
        ...
        if (
            ...
            raise ValueError(
                "ASTRA-native replay geometry continuity gate failed: "
    ...
    result.update(
        {
            ...
            "policy": (
                ...
                "junction and bounded centre-line overlap; ASTRA parity, rendered lane-length "
...
def retire_compact_scope_non_official_tls(
    *,
    ...
    This is deliberately a fail-closed promotion gate around ASTRA's reusable
