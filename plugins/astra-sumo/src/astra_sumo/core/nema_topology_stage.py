...
from astra_sumo.corridor.audit_pipeline import (
...
def clear_owned_nema_topology_stage(output_dir: Path) -> None:
    """Remove only a stage directory carrying ASTRA ownership metadata."""
    ...
    if not owner.is_file():
        raise ValueError("Refusing to remove a NEMA stage directory without ASTRA ownership metadata.")
