...
def _make_edge(edge_id: str, from_node: str, to_node: str, lanes: int, centerline: Sequence[tuple[float, float]], name: str) -> ET.Element:
    ...
    ET.SubElement(edge, "param", {"key": "astra:geometry_source", "value": "official_hh_sib_axis_boundary_stitch"})
    ET.SubElement(edge, "param", {"key": "astra:automatic_promotion", "value": "blocked_review_required"})
    return edge
