...
def read_canonical_count_file(path: Path) -> list[CanonicalCount]:
    """Read ASTRA's canonical 15-minute count CSV without losing provenance."""
...
def prepare_cached_detector_demand_package(
    *,
    ...
    """Build SUMO detector and route inputs from frozen ASTRA/Hamburg evidence.
...
def prepare_hamburg_corridor_candidate_package(
    *,
    ...
    """Run candidate MAP, signal-binding, and demand stages as one ASTRA package."""
