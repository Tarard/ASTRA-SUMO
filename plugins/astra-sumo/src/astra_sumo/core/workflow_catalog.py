...
SCENARIOS = {
    'environment_preflight': dict(kind='check', reference_bundle='astra-simulate', description='Check Python, SUMO and the available execution environment.',
        entrypoint='astra_sumo.tools.environment_tools:sumo_preflight', reference='preflight-sumo-environment.md'),
    'hamburg_network': dict(kind='workflow', reference_bundle='astra-build', description='Rebuild Hamburg road topology from user-supplied construction drawings or official MAP data, including continuous corridor lanes declared as road_runs. Check local connections and complete lane paths. Preserve the chosen year and source authority; do not calibrate counts.',
        entrypoint='astra_sumo.core.hamburg_topology_workflow:build_hamburg_topology_workflow', reference='hamburg-five-intersection-aerial-workflow.md'),
    'osm_network': dict(kind='workflow', reference_bundle='astra-build', description='Build and clean an OSM network for a declared area and traffic layers. Use hamburg_network when the task is led by Hamburg construction drawings.',
        entrypoint='astra_sumo.tools.osm_tools:sumo_osm_cleanup_workflow', reference='osm-to-sumo-workflow.md'),
    'intersection_scene': dict(kind='workflow', reference_bundle='astra-build', description='Build a synthetic intersection from a scene description. Do not use it to reconstruct a supplied real-road drawing.',
        entrypoint='astra_sumo.tools.intersection_tools:sumo_intersection_scene_workflow', reference='osm-to-sumo-workflow.md'),
    'intersection_clean': dict(kind='workflow', reference_bundle='astra-build', description='Clean and compile one local OSM intersection patch.',
        entrypoint='astra_sumo.tools.intersection_tools:sumo_intersection_clean', reference='osm-to-sumo-workflow.md'),
    'network_audit': dict(kind='check', reference_bundle='astra-build', description='Inspect an existing network and its lane connections without rebuilding it.',
        entrypoint='astra_sumo.mcp_contract_tools:astra_network_audit', reference='osm-to-sumo-workflow.md'),
    'network_compare': dict(kind='check', reference_bundle='astra-build', description='Compare a source network and a candidate network, preserving their identities.',
        entrypoint='astra_sumo.mcp_contract_tools:astra_network_compare', reference='osm-to-sumo-workflow.md'),
    'signal_classification': dict(kind='check', reference_bundle='astra-build', description='Classify signal devices and groups from an OCIT-C supply file; this does not generate field timing.',
        entrypoint='astra_sumo.tools.signal_tools:sumo_signal_device_profile_classify', reference='composable-signal-device-classification.md'),
    'tls_review': dict(kind='check', reference_bundle='astra-build', description='Review traffic signals using an existing network, OSM, and supplied inventory or field evidence.',
        entrypoint='astra_sumo.tools.osm_tools:sumo_tls_multisource_review', reference='model-osm-detectors.md'),
    'intersection_classification': dict(kind='check', reference_bundle='astra-build', description='Classify physical intersection structure before node joining or signal binding.',
        entrypoint='astra_sumo.tools.intersection_tools:sumo_intersection_archetype_classify', reference='composable-intersection-classification.md'),
    'detector_audit': dict(kind='check', reference_bundle='astra-calibrate', description='Compare expected detector counts and observed detector outputs.',
        entrypoint='astra_sumo.tools.demand_tools:sumo_detector_count_audit', reference='detector-constrained-demand-reconstruction.md'),
    'experiment_pair_audit': dict(kind='check', reference_bundle='astra-report', description='Check whether baseline and variant SUMO configurations form a valid comparison pair.',
        entrypoint='astra_sumo.tools.evidence_tools:sumo_config_pair_preflight', reference='evaluate-and-report-results.md'),
    'run_comparison': dict(kind='check', reference_bundle='astra-report', description='Compare already completed baseline and variant outputs. Do not start new simulations.',
        entrypoint='astra_sumo.tools.evidence_tools:sumo_compare_outputs', reference='evaluate-and-report-results.md',
        required_any=[['baseline_summary', 'baseline_tripinfo'], ['variant_summary', 'variant_tripinfo']]),
    'network_review': dict(kind='check', reference_bundle='astra-build', description='Create review HTML for an existing network and available audit outputs.',
        entrypoint='astra_sumo.tools.osm_tools:sumo_network_review_html', reference='osm-to-sumo-workflow.md',
    ...
    'road_design_review': dict(kind='check', reference_bundle='astra-build', description='Review source-bound engineering-plan width observations against the implemented rule fragments. Check edition, year and applicability; do not overwrite the user drawing.',
        entrypoint='astra_sumo.road_network.design_review:build_road_design_review', reference='hamburg-five-intersection-aerial-workflow.md'),
    'rigid_vehicle_sweep': dict(kind='check', reference_bundle='astra-build', description='Check a declared rigid vehicle along a front-bumper path against supplied road and obstacle polygons. Missing boundaries do not prove clearance; articulated vehicles are unsupported.',
        entrypoint='astra_sumo.road_network.rigid_vehicle_sweep:rigid_vehicle_sweep', reference='hamburg-five-intersection-aerial-workflow.md'),
    'detector_calibration': dict(kind='stage', reference_bundle='astra-calibrate', description='Fit route demand from detector constraints using routeSampler. This stage is not a complete simulation replay.',
        entrypoint='astra_sumo.tools.digital_twin_tools:sumo_detector_route_sampler_calibrate', reference='detector-constrained-demand-reconstruction.md'),
    'hamburg_demand': dict(kind='stage', reference_bundle='astra-calibrate', description='Generate and check Hamburg demand on a fixed network from bound counts and route candidates. Do not rebuild roads; SUMO replay is separate.',
        entrypoint='astra_sumo.core.hamburg_aerial_demand:generate_hamburg_aerial_demand', reference='hamburg-count-calibration-workflow.md'),
    'hamburg_replay': dict(kind='workflow', reference_bundle='astra-calibrate', description='Run the named Hamburg corridor replay from a fixed network, detector and signal bindings, and count snapshots.',
        entrypoint='astra_sumo.tools.digital_twin_tools:sumo_hamburg_sandtorkai_named_replay', reference='hamburg-sandtorkai-digital-twin.md'),
    'experiment_planning': dict(kind='guidance', reference_bundle='astra-simulate', description='Clarify an experiment objective, inputs and comparison design before choosing an execution workflow.',
        entrypoint=None, reference='interactive-experiment-intake.md'),
    'project_triage': dict(kind='guidance', reference_bundle='astra-simulate', description='Inspect a project or a bad run, identify the actual deviation, and then select the smallest relevant check.',
        entrypoint=None, reference='route-project-workflow.md'),
    'controller_design': dict(kind='guidance', reference_bundle='astra-simulate', description='Choose or develop a controller family with explicit observations, actions and comparison conditions.',
        entrypoint=None, reference='sumolights-controller-patterns.md'),
    'code_development': dict(kind='guidance', reference_bundle='astra-simulate', description='Implement or repair code using a failing check, the smallest change, and fresh verification.',
        entrypoint=None, reference='develop-and-verify-code.md'),
    'sumo_knowledge': dict(kind='guidance', reference_bundle='astra-simulate', description='Explain SUMO semantics or investigate a source-supported question without claiming a simulation was run.',
        entrypoint=None, reference='learn-sumo-knowledge.md'),
    'release_review': dict(kind='guidance', reference_bundle='astra-report', description='Review release readiness and exposure. Selecting this guide does not authorize publication.',
