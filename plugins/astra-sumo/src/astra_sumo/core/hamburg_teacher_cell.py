...
def build_hamburg_teacher_cell_contract(
    *,
    ...
    """Adapt official Hamburg MAP/OCIT topology to ASTRA's teacher-cell IR.
...
def build_hamburg_teacher_expression_grouping_variant(
    *,
    ...
    """Reuse ASTRA's identical-column compressor for official expressions."""
...
def materialize_hamburg_single_teacher_cell(
    *,
    ...
    """Materialize a one-cell Hamburg contract through ASTRA's native path.
    ...
    ``(from, to, fromLane, toLane)``, and only then applies ASTRA's identical-
