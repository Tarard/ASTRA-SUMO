...
from astra_sumo.intersection.road_sumo_binding import bind_intersection_road_detail_to_sumo
...
def _read_optional_hvs_source(
    *,
    ...
    from astra_sumo.road_network.adapters.hamburg_hvs import read_hamburg_hvs_snapshot
