...
def _write_edges(path: Path, plan: Mapping[str, Any], *, source_sha256: str) -> None:
    ...
    for edge in plan["edges"]:
        ...
        params = {
            ...
            "astra:source_sha256": source_sha256,
            "astra:hh_sib_road_key": edge["road_key"],
            "astra:hh_sib_feature_id": edge["feature_id"],
            "astra:station_from_m": _decimal(edge["station_from_m"], places=3),
            "astra:station_to_m": _decimal(edge["station_to_m"], places=3),
            "astra:station_direction": edge["direction"],
            "astra:speed_rule_raw": str(edge["speed_raw"]),
            "astra:carriageway_code_raw": str(edge["carriageway_code_raw"]),
            "astra:connection_status": "unresolved_official_map_stage",
        }
