...
def _parse_edges(
    ...
    *,
    ...
    for element in root.findall("edge"):
        ...
        station_direction = str(params.get("astra:station_direction", ""))
        ...
        edge_source_sha256 = str(params.get("astra:source_sha256", "")).lower()
        ...
        station_from = _finite_float(params.get("astra:station_from_m"), "station_from_m")
        station_to = _finite_float(params.get("astra:station_to_m"), "station_to_m")
