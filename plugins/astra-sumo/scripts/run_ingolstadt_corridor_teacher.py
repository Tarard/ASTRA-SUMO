...
def _parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        ...
        help=(
            ...
            "OSM/reference comparison to ASTRA's full reference-matched cleanup workflow."
        ),
    )
...
def _run_reference_matched(
    ...
    *,
    ...
    if workflow_func is None:
        from astra_sumo.tools.osm_tools import sumo_osm_cleanup_workflow
...
def main() -> int:
    ...
    source_root = repo_root / "plugins" / "astra-sumo" / "src"
    ...
    from astra_sumo.core.sumo_commands import discover_binaries
