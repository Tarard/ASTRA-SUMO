...
from astra_sumo.corridor.held_out_review_v2_r2_package import (  # noqa: E402
...
def main() -> None:
    parser = argparse.ArgumentParser(
        description="Execute the precommitted ASTRA Stage 1-M v2-R2 blinded review sample."
    )
    parser.add_argument(
        "--effective-corpus",
        type=Path,
