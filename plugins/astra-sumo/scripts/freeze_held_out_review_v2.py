...
from astra_sumo.core.artifact_io import write_json_atomic  # noqa: E402
from astra_sumo.corridor.held_out_review_v2 import (  # noqa: E402
    build_deterministic_replacement_plan_v2,
)
from astra_sumo.corridor.held_out_review_v2_preregistration import (  # noqa: E402
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Freeze ASTRA Stage 1-M held-out review v2 contracts.")
    parser.add_argument(
        "--base-benchmark",
        type=Path,
