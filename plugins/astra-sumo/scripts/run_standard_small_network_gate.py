...
PLUGIN_SRC = REPOSITORY_ROOT / "plugins" / "astra-sumo" / "src"
if str(PLUGIN_SRC) not in sys.path:
    sys.path.insert(0, str(PLUGIN_SRC))

from astra_sumo.core.sumo_commands import discover_binaries  # noqa: E402
from astra_sumo.corridor.standard_small_network_gate import (  # noqa: E402
