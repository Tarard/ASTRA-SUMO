...
ASTRA is a local stdio MCP server. Install `uv`, then configure the host with an
  ...
  "mcpServers": {
    "astra-sumo": {
      ...
      "args": [
        ...
        "--frozen",
        "--script",
        "C:\\path\\to\\astra-sumo\\scripts\\run_astra_sumo.py"
      ],
      "env": {
...
`astra-sumo` console script is also available.
